...
package kmac_pkg;
  ...
  parameter int unsigned NumAppModes = 4;
  // Application Algorithm
  // Each interface can choose algorithms among SHA3, cSHAKE, KMAC
  typedef enum bit [$clog2(NumAppModes)-1:0] {
  ...
  parameter app_config_t AppCfg [NumAppIntf] = '{
    ...
    '{
      ...
      Strength:   sha3_pkg::L256,   // Ignored
      PrefixMode: 1'b 0,            // No prefix
  ...
  parameter app_rsp_t APP_RSP_DEFAULT = '{
    ...
    digest_share1: AppDigestW'(32'hDEADBEEF),
    error: 1'b1
  };
