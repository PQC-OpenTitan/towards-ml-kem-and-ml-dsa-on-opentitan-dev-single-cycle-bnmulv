...
#(
  ...
  output mulv_predec_bignum_t      mulv_predec_bignum_o,
  ...
  mulv_predec_bignum_t  mulv_predec_bignum, mulv_predec_bignum_q, mulv_predec_bignum_d;
  ...
  assign mulv_predec_bignum_d = insn_fetch_en ? mulv_predec_bignum : mulv_predec_bignum_q;
  ...
  prim_flop #(
    .Width($bits(mulv_predec_bignum_t)),
    .ResetValue('0)
  ) u_mulv_predec_bignum_flop (
    .clk_i,
    .rst_ni,

    .d_i(mulv_predec_bignum_d),
    .q_o(mulv_predec_bignum_q)
  );
  ...
  assign mulv_predec_bignum_o      = mulv_predec_bignum_q;
