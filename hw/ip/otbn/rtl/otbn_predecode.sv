...
#(
  ...
  logic mulv_bignum_op_en;
  mulv_type_t mulv_bignum_type;
  ...
  always_comb begin
    ...
    mulv_bignum_op_en     = 1'b0;
    mulv_bignum_type      = mulv_type_t'('0);
  ...
  assign mulv_predec_bignum_o.op_en     = mulv_bignum_op_en;
  assign mulv_predec_bignum_o.mulv_type = mulv_bignum_type;
