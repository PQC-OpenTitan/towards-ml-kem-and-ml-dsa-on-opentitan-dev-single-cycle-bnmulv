...
$fwrite(f,"----------------------------------------------------------------\n");   
$fwrite(f,"-- Testcase 5 - BNADDV - Random\n");
$fwrite(f,"----------------------------------------------------------------\n");
...
for (int i=0 ; i<8 ; i++) begin 
    wdr_res[0][i*32+:32] = wdr_op0[0][i*32+:32]-wdr_op1[0][i*32+:32];
end
for (int i=0 ; i<8 ; i++) begin 
    wdr_res[1][i*32+:32] = wdr_op0[1][i*32+:32]+wdr_op1[1][i*32+:32];
end
for (int i=0 ; i<8 ; i++) begin 
    wdr_res[2][i*32+:32] = wdr_op0[2][i*32+:32]-wdr_op1[2][i*32+:32];
end
for (int i=0 ; i<8 ; i++) begin 
    wdr_res[3][i*32+:32] = wdr_op0[3][i*32+:32]+wdr_op1[3][i*32+:32];
end
...
// Compute Expected Results for Dilithium
for (int i=0 ; i<16 ; i++) begin 
    wdr_res[4][i*16+:16] =wdr_op0[4][i*16+:16]-wdr_op1[4][i*16+:16];
end
for (int i=0 ; i<16 ; i++) begin 
    wdr_res[5][i*16+:16] = wdr_op0[5][i*16+:16]+wdr_op1[5][i*16+:16];
end
for (int i=0 ; i<16 ; i++) begin 
    wdr_res[6][i*16+:16] = wdr_op0[6][i*16+:16]-wdr_op1[6][i*16+:16];
end
for (int i=0 ; i<16 ; i++) begin 
    wdr_res[7][i*16+:16] = wdr_op0[7][i*16+:16]+wdr_op1[7][i*16+:16];
end
