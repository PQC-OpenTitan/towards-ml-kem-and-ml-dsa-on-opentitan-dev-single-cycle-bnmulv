...
$fwrite(f,"----------------------------------------------------------------\n");   
$fwrite(f,"-- Testcase 9 - BNTRN - Random\n");
$fwrite(f,"----------------------------------------------------------------\n");
...
// Operand 3
for (int i=0 ; i<8 ; i++) begin 
    wdr_word[i*32+:32] = $urandom(1692+i);
end
for (int i=0 ; i<8 ; i++) begin 
...
// Operand 4
for (int i=0 ; i<8 ; i++) begin 
    wdr_word[i*32+:32] = $urandom(623+i);
end
for (int i=0 ; i<8 ; i++) begin 
...
// Operand 5
for (int i=0 ; i<8 ; i++) begin 
    wdr_word[i*32+:32] = $urandom(912+i);
end
for (int i=0 ; i<8 ; i++) begin 
...
// Operand 6
for (int i=0 ; i<8 ; i++) begin 
    wdr_word[i*32+:32] = $urandom(999+i);
end
for (int i=0 ; i<8 ; i++) begin 
...
// Operand 7
for (int i=0 ; i<8 ; i++) begin 
    wdr_word[i*32+:32] = $urandom(357+i);
end
for (int i=0 ; i<8 ; i++) begin 
...
// Operand 8
for (int i=0 ; i<8 ; i++) begin 
    wdr_word[i*32+:32] = $urandom(671+i);
end
for (int i=0 ; i<8 ; i++) begin 
